import "./footer.css";
import locationQR from "./../../images/I-Pro location QR.png";
import iProLogo from "./../../images/i-pro_logo_with_trans.png";
import emailIcon from "../../images/email icon.png";
import callIcon from "../../images/call icon.png";
import locationIcon from "../../images/location icon.png";
import facebokLogo from "../../images/facebook icon.png";
import xLogo from "../../images/x-logo icon.png";
import linkedinLogo from "../../images/linkedin-logo icon.png";
import instaLogo from "../../images/instagram-logo icon.png";
          ...
          <div className="footer-links">
            ...
            <div>
              ...
              <ul>
                ...
                <li><a href="#">Why I Pro Infinity</a></li>
              </ul>
            </div>
            <div>
              <h4>Policy</h4>
